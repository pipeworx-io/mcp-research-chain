...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/research_chain \
  -H 'Content-Type: application/json' \
  -d '{"doi":"10.1038/s41586-020-2649-2"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/research_chain`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
